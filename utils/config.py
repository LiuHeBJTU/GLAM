...
__C.VISFEA_TYPE_PRETRAINED_VGG16 = 'preVGG16'
__C.VISFEA_TYPE_BBGM="BBGM"
...
__C.VOC2011.CLASSES = ['aeroplane', 'bicycle', 'bird', 'boat', 'bottle', 'bus', 'car', 'cat', 'chair', 'cow',
                       ...
                       'tvmonitor']
__C.MEAN_POOLING_INTERVAL_PASCAL=1
...
__C.MEAN_POOLING_INTERVAL_WILLOW = 1
cfg.MEAN_POOLING_INTERVAL_SPAIR = 1
# GMN model options
__C.GMN = edict()
